// Admin reset password page: reads token from query string and posts new password.
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-6">
        <div className="text-center">
          ...
          <button onClick={() => navigate("/forgot-password")} className="text-blue-500 text-sm hover:underline">
            Request a new one
          </button>
        </div>
      </div>
