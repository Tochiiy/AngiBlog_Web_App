// Admin login/register page used for site administrators.
// On success stores token and admin info in localStorage and navigates to /admin.
import { useState } from "react";
import { useNavigate } from "react-router-dom";
import { registerAdmin, loginAdmin } from "../services/api.js";
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-6">
      <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-8 w-full max-w-md">
        ...
        <p className="text-gray-500 text-sm mb-6">
          {isRegister ? "Register to manage your blog" : "Sign in to your admin panel"}
        </p>
